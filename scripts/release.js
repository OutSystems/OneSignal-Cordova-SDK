 ...
 * @param {string} version - Version string like "2.11.1-OS19"
 * @returns {number} - The versionCode (19)
 */
 ...
 * @returns {string} - Next version like "2.11.1-OS20"
 */
...
async function getCommitsSinceLastTag() {
  try {
    ...
    // Example: 2.11.1-OS19, 2.11.1-OS20, etc.
